...
export default async function AllTutorsPage() {
  ...
  return (
    <div>
      <div className="mb-8">
        <h1 className="text-3xl font-black text-primary font-playfair tracking-tight mb-2">Our Instructors</h1>
        <p className="text-primary/60">Learn from the best in the field of IVF and infertility.</p>
      </div>
