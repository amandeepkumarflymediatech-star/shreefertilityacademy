  ...
  return (
    <>
      <div className="flex justify-between items-center bg-white p-6 rounded-2xl shadow-sm border border-secondary/20 mb-6">
        <div>
          <h1 className="text-2xl font-black text-primary font-playfair tracking-tight">Global SEO</h1>
          <p className="text-primary/60 text-sm mt-1">Manage meta tags, titles, and open graph data per page.</p>
        </div>
        <Link 
          href="/admin/seo/new"
